...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-xs-12 mb-1">
    <h2 class="content-header-title">Meeting as a Help Provider </h2>
  </div>
  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
    <div class="breadcrumb-wrapper col-xs-12">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Provider Meeting
      </ol>
    </div>
  </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    <p class="card-text">You can manage meeting by click on it.</p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel1">Meeting with <span class="seekerName"></span></h4>
          </div>
          <div class="modal-body">
            ...
            <table class="table" id="newColDetails">
                ...
                <tr id="cancelCol">
                    ...
                    <td>
                      <a class="btn btn-info btn-sm acceptReq text-white"  href="javascript:void(0)"  >Accept</a> 
                      <a class="btn btn-danger  btn-sm text-white cancelReq" href="javascript:void(0)" >Cancel</a></td>
                </tr>
            </table>
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    type: 'post',
                                    url: '/accept-meeting/'+collaborationId,
                                    beforeSend: function(){
                                      $('.conImageCenter').show(400);
                                    },
                                    data: {
