...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-xs-12 mb-1">
    <h2 class="content-header-title">All Collaboration as a Help Seeker </h2>
  </div>
  <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
    <div class="breadcrumb-wrapper col-xs-12">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Seeker Collaboration
      </ol>
    </div>
  </div>
</div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Your Collaboration</h4>
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    <p class="card-text">You can manage it by click on an event</p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel1">Collaboration with <span class="providerName"></span></h4>
          </div>
          <div class="modal-body">
            ...
            <table class="table" id="newColDetails">
                ...
                <tr id="instructId">
                    <td><h5><i class="icon-file2"></i> Provider instruction</h5></td>
  ...
  jQuery(document).ready(function($) {
    ...
    $('#calendar').fullCalendar({
      ...
      events:[
          ...
          {
              id:'{{$event->id}}',    
              title:'Collaboration with {{$event->provider->name}}',    
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                              ...
                              if(data == "success"){
                                ...
                                $(cancelReqBtn).removeAttr("href");
                                $(cancelReqBtn).removeClass("cancelReq");
