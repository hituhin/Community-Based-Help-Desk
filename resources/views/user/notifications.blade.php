        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    <p class="card-text" style="display: inline-block; text-align: left;">You can view details by clicking the title.</p>
                    ...
                    <div class="table-responsive">
                        <table class="table" id="table">
                            <thead>
                                ...
                                <tr>
                                    <th>#</th>
                                    <th class="no-sort">Notification title</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                  <th scope="row">{{$id}}</th>
                                  <td ><a href="{{ $notification->data['url'] }}" style="color: #373a3c; display: block;
width: 100%;">{{ $notification->data['text'] }} !</a></td>
