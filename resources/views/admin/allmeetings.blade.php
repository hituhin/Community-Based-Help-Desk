        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    <p class="card-text">You can see details by hover on the title</p>
    ...
    $('#calendar').fullCalendar({
      ...
      events:[
          @foreach($getevents as $event)
          {
              ...
              @else
                  @if($event->provider_id == Auth::guard('admin')->user()->id)
                    title:'Meeting between {{$event->provider->name}} & {{$event->seeker->name}}',
                  @else
                    title:'Meeting between {{$event->provider->name}} & {{$event->seeker->name}}',
                  @endif
              @endif    
