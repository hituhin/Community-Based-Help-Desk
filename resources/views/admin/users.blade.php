        ...
        <div class="card">
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    <p class="card-text">You can deactive user by clicking deactive button.</p>
                        ...
                        <table class="table" id="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  <th scope="row">{{$id}}</th>
                                  <td>{{ $user->name }}</td>
                                  <td><a href="{{ route('admin.user-profile',['id'=>$user->id]) }}" class="btn btn-success  btn-sm ">Visit profile</a></td>
                                  <td>{{ $user->created_at->diffForHumans() }}</td>
                                  <td>

                                        <button class="btn btn-danger btn-sm text-white deactive-user" data-id="{{$user->id}}">Deactive</button>
                                    </td>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-danger" >Yes, Deactive</button>
...
$(document).ready(function() {
  ...
  $('body').on('click', '.deactive-user', function () {
      ...
      form.action = '/admin/user-deac/' + userId;
