...
<div class="content-header row">
  <div class="content-header-left col-md-6 col-xs-12 mb-1">
    <h2 class="content-header-title">All Admins</h2>
  </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">All active admins</h4>
            ...
            <div class="card-body collapse in">
                <div class="card-block card-dashboard">
                    <p class="card-text">You can edit information, deactive and delete the admin by following action buttons.</p>
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                        ...
                                        <a href="{{ route('admin.edit',['id'=>$user->id]) }}" class="btn btn-info btn-sm text-white " data-id="{{$user->id}}">Edit</a>
                                        <button class="btn btn-warning btn-sm text-white deactive-user" data-id="{{$user->id}}">Deactive</button>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel1">Deactive user</h4>
      </div>
      <div class="modal-body">
        <p class="text-center text-bold" style="font-size: 17px">
           Are you sure you want to deactive this admin ?
        </p>

        
     </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-warning" >Yes, Deactive</button>
...
$(document).ready(function() {
  ...
  $('body').on('click', '.deactive-user', function () {
      ...
      form.action = '/admin/deactive/' + userId;
